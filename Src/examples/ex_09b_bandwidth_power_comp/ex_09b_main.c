 ...
 * See NOTE 2 below.
 */
/* For this example the user should run the example ex_09a on their individual EVB unit and write down the values to the debug UART: for
...
int dw_main(void)
{
    ...
    /*Initially configure DW1000 with reference TX power and PG delay*/
    txconfig.PGdly = reference.PGdly;
    txconfig.power = reference.power;
