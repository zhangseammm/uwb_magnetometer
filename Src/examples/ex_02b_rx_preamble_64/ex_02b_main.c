...
int dw_main(void)
{
    ...
    /*The optimised configuration for 64 length preamble is achieved by calling dwt_configurefor64plen API function */
 ...
 *    used here (i.e. 64-symbol preamble and non-standard SFD).
